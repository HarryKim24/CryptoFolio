...
test('chart page interaction test', async ({ page }) => {
  ...
  await page.waitForSelector('input[placeholder="코인명 또는 심볼 검색"]', {
    state: 'visible',
  });
  ...
  const searchSteps = ['ㅇ', 'ㅇㄷ', 'ㅇㄷㄹ', 'ㅇㄷㄹㅇ'];

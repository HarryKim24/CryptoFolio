...
const videoOutput = path.join(outputDir, 'chart.mp4');
const gifOutput = path.join(outputDir, 'chart.gif');
...
async function main() {
  ...
  try {
    runCommand('npx playwright test tests/chart.spec.ts --project=chromium');
  } catch {

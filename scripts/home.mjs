...
const videoOutput = path.join(outputDir, 'home.mp4');
const gifOutput = path.join(outputDir, 'home.gif');
...
async function main() {
  ...
  try {
    runCommand('npx playwright test tests/home.spec.ts --project=chromium');
  } catch {

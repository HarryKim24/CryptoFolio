      ...
      <div className='space-y-6'>
        ...
        >
          <button
            ...
            className="bg-chart hover:brightness-105 min-w-[188px] text-neutral-100 text-2xl font-semibold py-2 px-6 rounded transition"
          >
            차트 확인하기
          </button>
          <button
            onClick={handleMainAction}
            className="bg-portfolio hover:brightness-105 min-w-[188px] text-neutral-100 text-2xl font-semibold py-2 px-6 rounded transition"
          >
            {session ? '내 포트폴리오' : '로그인'}
          </button>
        </motion.div>
